...
<body class="d-flex flex-column h-100">
    ...
    <div class="container form-signin mt-auto">
        ...
        <span class="smaller-font">You can login using:<br /><span class="xsmall-font">Username: student , Password: 123</span></span>
            <a class="nav nav-item text-decoration-none text-muted mb-2 mt-2 small" href="shop/shop_login.php">
